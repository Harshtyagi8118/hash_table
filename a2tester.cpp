...
bool test1(std::string keys[], int data[], int max, std::string& error){
	...
	// SimpleTable<int> table1(1000);
	// SimpleTable<int> table2(10000);
	// SimpleTable<int> table3(20000);
...
void createData(std::string keys[],int data[],int max){
	...
	if(!fp){
        std :: cerr << "You need dictionary.txt in your current directory" << std::endl;
		exit(0);
	}
	int i=0;
	std::string front="A_";
